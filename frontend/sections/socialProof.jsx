...
function ImageContainter({props}){
  ...
  return(
    <div className="min-h-[47vh] sm:w-1/2 sm:ml-12 sm:-mt-16 sm:-mb-16 sm:min-h-[60vh] sm:max-w-[30vw] bg-cover bg-top rounded-t-lg sm:rounded-lg relative overflow-hidden
