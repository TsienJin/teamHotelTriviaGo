...
export default async function handler(req, res) {
    ...
    try {
        ...
        const result = await client.db("HotelTriviaGodb").collection("mdna_test").findOne({sessionToken: req.body.pid}, {projection: {usrPassword: 1, isComplete: 1, mdna: 1,_id:0}})
